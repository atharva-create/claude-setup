...
- **Global scope**: `/Users/atharvashetye/Desktop/codelens/claude_setup/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/atharvashetye/Desktop/codelens/claude_setup/.claude/notes/`)
...
2. Glob `/Users/atharvashetye/Desktop/codelens/claude_setup/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/atharvashetye/Desktop/codelens/claude_setup/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/atharvashetye/Desktop/codelens/claude_setup/.claude/notes/` — works in any directory
